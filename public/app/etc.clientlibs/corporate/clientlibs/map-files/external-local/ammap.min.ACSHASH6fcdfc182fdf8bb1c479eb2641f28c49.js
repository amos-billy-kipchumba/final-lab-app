...
(function () {
  ...
  d.formatDuration = function (a, b, c, e, g, f) {
    ...
    if (a >= k[b].contains) {
      ...
      "ss" == b
        ? ((l = d.formatNumber(l, f)), 1 == l.split(h)[0].length && (l = "0" + l))
  ...
  d.formatNumber = function (a, b, c, e, g) {
    ...
    if (l) m = h;
      ...
      for (n = l.length; 0 <= n; n -= 3)
        m =
          n != l.length ? (0 !== n ? l.substring(n - 3, n) + b + m : l.substring(n - 3, n) + m) : l.substring(n - 3, n);
        ...
        if ("[object Array]" === Object.prototype.toString.call(a))
          ...
          try {
            for (c in ((a.theme = null), a))
              a[c] &&
                ("object" == typeof a[c] && d.deleteObject(a[c], b - 1), "function" != typeof a[c] && (a[c] = null));
          } catch (e) {}
    }
  };
      ...
      if (d.hasSVG) {
        ...
        a &&
          ...
          a.accessibleDescription &&
            ((b.innerHTML = ""), b.appendChild(document.createTextNode(a.accessibleDescription))),
          c.appendChild(b),
    ...
    brr: function () {
      if (!this.hideCredits) {
        ...
        if (c != a || !0 === this.inIframe()) {
          ...
          "ammap" == this.product &&
            ((c = a + "/javascript-maps/"), (b = "Interactive JavaScript maps"), (e = "JS map by amCharts"));
...
(function () {
  ...
  d.AmBalloon = d.Class({
    construct: function (a) {
      ...
      this.enabled = !0;
      this.fillColor = "#232325";
      this.fillAlpha = 0.8;
      this.borderThickness = 0;
      this.borderColor = "#232325";
      this.borderAlpha = 1;
      this.cornerRadius = 5;
      this.maxWidth = 220;
      ...
      if (!isNaN(a)) {
        ...
        if (this.show) {
          ...
          "H" != u
            ...
            : (2 * B > w && (B = w / 2),
              (A = b - w / 2),
              a < k + (l - k) / 2 ? ((x = a + B), (this.deltaSignX = -1)) : ((x = a - z - B), (this.deltaSignX = 1)));
          A + w >= m && (A = m - w);
          A < h && (A = h);
          x < k && (x = k);
          x + z > l && (x = l - z);
            ...
            : ((t = []),
              ...
              "H" != u
                ? ((k = a - x),
                  ...
                  (v = H ? [0, 0, b - A, 0, 0, w, w, 0] : [w, w, b - A, w, w, 0, 0, w]))
                : ((u = b - A),
                  u > w - B && (u = w - B),
                  u < B && (u = B),
...
(function () {
  ...
  d.text = function (a, b, c, e, g, f, k, h) {
    ...
    isNaN(h) && (h = 1);
    void 0 !== b &&
      ((b = String(b)), d.isIE && !d.isModern && ((b = b.replace("&amp;", "&")), (b = b.replace("&", "&amp;"))));
    ...
    for (var e = [], d = [], f = 1; f < a.length; f++)
      for (
        var k = Number(a[f - 1]),
          ...
          l = Number(a[f]),
          m = Number(b[f]),
          n = Math.round(Math.sqrt(Math.pow(l - k, 2) + Math.pow(m - h, 2)) / 50) + 1,
          l = (l - k) / n,
          m = (m - h) / n,
          p = 0;
        p <= n;
  ...
  d.drop = function (a, b, c, e, d, f, k, h) {
    ...
    b =
      ...
      "," +
      t +
      (" A" + q + "," + q + ",0,0,0," + (Math.sin((m + 20) * l) * b + B) + "," + (Math.cos((m + 20) * l) * b + y));
    b += " A" + q + "," + q + ",0,0,0," + n + "," + p;
    ...
    B
      ? (G ||
          (g =
            ...
            "," +
            q(z)),
        (k = " M" + q(u) + "," + q(w) + " L" + q(A) + "," + q(C) + g + " L" + q(E) + "," + q(v)))
      : (k =
          " M" +
          u +
          "," +
...
(function () {
  ...
  d.AmLegend = d.Class({
    ...
    arrangeEntries: function () {
      ...
      l = v.height + 2 * m - 1;
      "left" == a || "right" == a
        ? ((n = v.width + 2 * f), (h = n + b + c), (k.style.width = h + "px"), (this.ieW = h))
        : (n = h - b - c - 1);
      c = d.polygon(
        this.container,
        [0, n, n, 0],
    ...
    createEntry: function (a) {
      if (!1 !== a.visibleInLegend && !a.hideFromLegend) {
        ...
        c.accessible &&
          b.accessibleLabel &&
          ((l = d.massReplace(b.accessibleLabel, { "[[title]]": a.title })), c.makeAccessible(p, l));
        l = b.fontSize;
        m &&
          (r <= l && ((r = r / 2 + b.ly - l / 2 + (l + 2 - r) / 2 - q), m.translate(y, r), u && u.translate(u.x, r)),
        ...
        f &&
          ...
          (v = isNaN(v)
            ...
            : d.wrappedText(b.container, f, h, c.fontFamily, l, "start", !1, v, 0)),
            ...
            if (void 0 !== f.type) {
              ...
              h
                ...
                : l &&
                  ...
                  ((l = d.massReplace(l, { "[[title]]": f.title })), (k = b.formatPeriodString(l, f)));
  ...
  d.AmMap = d.Class({
      ...
      if (d.isModern) {
        ...
        if (!a.preventHover) {
          ...
          isNaN(c) ||
            ...
            ((a.mapWasDragged = !0),
            (b = { type: "dragCompleted", zoomX: a.zoomX(), zoomY: a.zoomY(), zoomLevel: a.zoomLevel(), chart: a }),
            a.fire(b));
    ...
    handleMouseMove: function (a) {
      ...
      if (!a || !a.touches || !b.tapToActivate || b.tapped) {
        ...
        if ((a = b.mapContainer)) {
          ...
          b.mouseIsDown &&
            b.dragMap &&
            (3 < Math.abs(b.previuosMouseX - b.mouseX) || 3 < Math.abs(b.previuosMouseY - b.mouseY)) &&
            (b.isDragging = !0);
          if (!isNaN(h)) {
            b.stopDrag();
    ...
    selectObject: function (a, b) {
      ...
      if (
        e &&
        !f &&
        (d.isString(e) && (e = c.getObjectById(e)), isNaN(a.zoomLevel) && isNaN(a.zoomX) && isNaN(a.zoomY))
      ) {
      ...
      if (b) {
        ...
        if (a.showAsSelected) {
          ...
          "MapImage" == a.objectType &&
            ((h = this.imagesSettings.selectedOutlineColor), (l = this.imagesSettings.selectedOutlineThickness));
          "MapArea" == a.objectType &&
            ((h = this.areasSettings.selectedOutlineColor), (l = this.areasSettings.selectedOutlineThickness));
          void 0 !== h && (k = h);
          void 0 !== l && (f = l);
        }
    ...
    showAsRolledOver: function (a) {
      ...
      if (!a.showAsSelected && b && !a.isOver) {
        ...
        "bubble" == a.type && (c = void 0);
        void 0 == c &&
          (isNaN(a.rollOverBrightnessReal) || (c = d.adjustLuminosity(a.colorReal, a.rollOverBrightnessReal / 100)));
        if (void 0 != c)
        ...
        "MapImage" == a.objectType &&
          ...
          isNaN(c) ||
            1 == c ||
            ((e = b.scale), isNaN(e) && (e = 1), (a.tempScale = e), b.translate(b.x, b.y, e * c, !0)));
    ...
    extendMapData: function (a) {
      ...
      if ("MapImage" != b && "MapArea" != b && "MapLine" != b)
        return (
          d.extend(a, new d.MapData(), !0), (this.dataProvider = a), (this.zoomInstantly = !0), this.validateData(), !0
        );
    },
    ...
    getDevInfo: function () {
      var a = this.zoomLevel(),
        ...
        b =
          "zoomLevel:" + a.zoomLevel + ", zoomLongitude:" + a.zoomLongitude + ", zoomLatitude:" + a.zoomLatitude + "\n",
      ...
      if ((f = c.invert)) {
        ...
        this.projectionChanged &&
          ((l = d.radiansToDegrees(
            c(d.degreesToRadians(this.topLongLat.longitude), d.degreesToRadians(this.topLongLat.latitude))[1]
          )),
          (m = d.radiansToDegrees(
            c(d.degreesToRadians(this.bottomLongLat.longitude), d.degreesToRadians(this.bottomLongLat.latitude))[1]
          )),
          (k = d.radiansToDegrees(
            c(d.degreesToRadians(this.leftLongLat.longitude), d.degreesToRadians(this.leftLongLat.latitude))[0]
          )),
          (h = d.radiansToDegrees(
            c(d.degreesToRadians(this.rightLongLat.longitude), d.degreesToRadians(this.rightLongLat.latitude))[0]
          )));
  ...
  d.ZoomControl = d.Class({
    ...
    init: function (a, b) {
      ...
      k &&
        ...
        C
          ? (y.svgIcon = d.line(b, [x / 5, -x + x / 5, x / 5], [-x, 0, x], w, v, 1))
        ...
        (y = new d.SimpleButton()),
        C
          ? (y.svgIcon = d.line(b, [-x, 0, x], [x / 5, -x + x / 5, x / 5], w, v, 1))
  ...
  d.SmallMap = d.Class({
    ...
    init: function (a, b) {
      ...
      if (c.enabled) {
        ...
        a.svgIcons
          ? (r.svgIcon = d.line(b, [-p / 2, 0, p / 2], [p / 4, -p / 4, p / 4], c.iconColor, 1, 1))
  ...
  d.AreasProcessor = d.Class({
    ...
    process: function (a) {
      ...
      for (d = 0; d < c; d++)
        (g = a[d]),
          isNaN(g.value)
            ? (g.percents = void 0)
            : ((g.percents = ((g.value - h) / f) * 100), h == k && (g.percents = 100));
    ...
    updateAllAreas: function () {
      ...
      for (n = 0; n < k.length; n++) {
        ...
        h.getAreasFromMap &&
          !m[l.id] &&
          ((r = new d.MapArea(a.theme)), (r.parentObject = h), (r.id = l.id), (r.outline = l.outline), h.areas.push(r));
      }
    },
    createArea: function (a) {
      ...
      if (
        ...
        v && !a.title && (a.title = v),
        (c = b.language)
          ? (v = d.mapTranslations) && (c = v[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle])
          : (a.titleTr = void 0),
        p)
      ) {
        c = a.tabIndex;
  ...
  d.ImagesProcessor = d.Class({
    ...
    createImage: function (a, b) {
      ...
      if (n) {
        ...
        "kilometers" == a.widthAndHeightUnits &&
          ((C = c.kilometersToPixels(a.width)), (F = c.kilometersToPixels(a.height)));
    ...
    updateSizeAndPosition: function (a) {
      ...
      if (!isNaN(e) && !isNaN(g)) c.translate(e, g, NaN, !0);
        ...
        if (
          ((g = b.coordinatesToXY(h, l)), (e = g.x), (g = g.y), isNaN(p) || (e = p), isNaN(r) || (g = r), a.fixedSize)
        ) {
          p = a.positionScale;
      ...
      if (a.remainVisible || c.selectedObject == a.parentObject) {
        ...
        if (0 < w.length) {
          ...
          if (isNaN(q)) {
            ...
            l = x
              .path(h)
              .attr({ "fill-opacity": 0, stroke: l, "stroke-width": 5 / n, "stroke-opacity": 0.001, fill: "none" });
          }
